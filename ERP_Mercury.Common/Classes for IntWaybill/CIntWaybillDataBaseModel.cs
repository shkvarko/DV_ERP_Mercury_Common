...
namespace ERP_Mercury.Common
{
    public class CIntWaybillDataBaseModel
    {
            ...
            System.Data.SqlClient.SqlCommand cmdSQL, System.Guid uuidIntWaybillId, ref System.String strErr, System.Boolean bTableFromIntOrder = false)
        {
            ...
            dtReturn.Columns.Add(new System.Data.DataColumn("IntWaybItem_MarkUpPercent", typeof(System.Double)));
            ...
            try
            {
                ...
                if (rs.HasRows)
                {
                    ...
                    while (rs.Read())
                    {
                        ...
                        newRow["IntWaybItem_MarkUpPercent"] = rs["IntWaybItem_MarkUpPercent"];
            ...
            System.Data.DataTable WaybillGuidList, System.Boolean CanShip, ref System.String strErr)
        {
            ...
            try
            {
                ...
                cmd.CommandText = System.String.Format("[{0}].[dbo].[usp_SetShipRemarkForIntWaybills]", objProfile.GetOptionsDllDBName());
                cmd.Parameters.Add(new System.Data.SqlClient.SqlParameter("@RETURN_VALUE", System.Data.SqlDbType.Int, 4, System.Data.ParameterDirection.ReturnValue, false, ((System.Byte)(0)), ((System.Byte)(0)), "", System.Data.DataRowVersion.Current, null));
