...
{
    /// <summary>
    /// Класс "Вид отгрузки накладной на внутреннее перемещение"
    /// </summary>
    public class CIntWaybillShipMode : CBusinessObject
    {
        #region Свойства
        /// <summary>
        /// Примечание
        ...
        public override System.Boolean Add(UniXP.Common.CProfile objProfile)
        {
            ...
            System.Boolean bRet = CIntWaybillShipModeDataBaseModel.AddNewObjectToDataBase(
        ...
        public override System.Boolean Update(UniXP.Common.CProfile objProfile)
        {
            ...
            System.Boolean bRet = CIntWaybillShipModeDataBaseModel.EditObjectInDataBase(this.ID,
        ...
        public override System.Boolean Remove(UniXP.Common.CProfile objProfile)
        {
            ...
            System.Boolean bRet = CIntWaybillShipModeDataBaseModel.RemoveObjectFromDataBase(this.ID, objProfile, ref strErr);
            if (bRet == false)
            {
                DevExpress.XtraEditors.XtraMessageBox.Show(strErr, "Внимание",
                    System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Error);
    ...
    /// </summary>
    public static class CIntWaybillShipModeDataBaseModel
    {
